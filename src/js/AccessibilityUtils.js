...
axs.utils.Color = function(red, green, blue, alpha) {
    ...
    goog.exportProperty(this, 'red', this.red);
    goog.exportProperty(this, 'green', this.green);
    goog.exportProperty(this, 'blue', this.blue);
    goog.exportProperty(this, 'alpha', this.alpha);
};
